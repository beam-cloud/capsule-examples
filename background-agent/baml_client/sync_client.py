...
class BamlSyncClient:
    ...
    def SummarizeSignal(self, topic: str,now: str,
        ...
        if 'on_tick' in baml_options:
            ...
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="SummarizeSignal", args={
                "topic": topic,"now": now,
            })
...
class BamlStreamClient:
    ...
    def SummarizeSignal(self, topic: str,now: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.SignalSummary, types.SignalSummary]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="SummarizeSignal", args={
            "topic": topic,"now": now,
        })
        return baml_py.BamlSyncStream[stream_types.SignalSummary, types.SignalSummary](
          __result__,
...
class BamlHttpRequestClient:
    ...
    def SummarizeSignal(self, topic: str,now: str,
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="SummarizeSignal", args={
            "topic": topic,"now": now,
        }, mode="request")
        return __result__
