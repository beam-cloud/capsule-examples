...
class BamlAsyncClient:
    ...
    async def AnswerQuestion(self, question: str,context: str,style: str,system_prompt: str,
        baml_options: BamlCallOptions = {},
    ) -> str:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            # Use streaming internally when on_tick is provided
            __stream__ = self.stream.AnswerQuestion(question=question,context=context,style=style,system_prompt=system_prompt,
                baml_options=baml_options)
            return await __stream__.get_final_response()
        else:
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="AnswerQuestion", args={
                "question": question,"context": context,"style": style,"system_prompt": system_prompt,
            })
            return typing.cast(str, __result__.cast_to(types, types, stream_types, False, __runtime__))
    async def ClassifyMessage(self, message: str,
        baml_options: BamlCallOptions = {},
    ) -> types.MessageIntent:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
    ...
    async def DraftTaskResult(self, prompt: str,context: str,system_prompt: str,
        baml_options: BamlCallOptions = {},
    ) -> str:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            # Use streaming internally when on_tick is provided
            __stream__ = self.stream.DraftTaskResult(prompt=prompt,context=context,system_prompt=system_prompt,
                baml_options=baml_options)
            return await __stream__.get_final_response()
        else:
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="DraftTaskResult", args={
...
class BamlStreamClient:
    ...
    def AnswerQuestion(self, question: str,context: str,style: str,system_prompt: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[str, str]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="AnswerQuestion", args={
            "question": question,"context": context,"style": style,"system_prompt": system_prompt,
        })
    ...
    def ClassifyMessage(self, message: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.MessageIntent, types.MessageIntent]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="ClassifyMessage", args={
            "message": message,
        })
        return baml_py.BamlStream[stream_types.MessageIntent, types.MessageIntent](
          __result__,
    ...
    def DraftTaskResult(self, prompt: str,context: str,system_prompt: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[str, str]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="DraftTaskResult", args={
            "prompt": prompt,"context": context,"system_prompt": system_prompt,
        })
        return baml_py.BamlStream[str, str](
          __result__,
...
class BamlHttpRequestClient:
    ...
    async def AnswerQuestion(self, question: str,context: str,style: str,system_prompt: str,
        ...
        __result__ = await self.__options.merge_options(baml_options).create_http_request_async(function_name="AnswerQuestion", args={
            "question": question,"context": context,"style": style,"system_prompt": system_prompt,
        }, mode="request")
        return __result__
    async def ClassifyMessage(self, message: str,
    ...
    async def DraftTaskResult(self, prompt: str,context: str,system_prompt: str,
        ...
        __result__ = await self.__options.merge_options(baml_options).create_http_request_async(function_name="DraftTaskResult", args={
            "prompt": prompt,"context": context,"system_prompt": system_prompt,
        }, mode="request")
        return __result__
