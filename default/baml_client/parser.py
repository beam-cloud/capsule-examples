...
class LlmResponseParser:
    ...
    def DraftTaskResult(
        ...
        __result__ = self.__options.merge_options(baml_options).parse_response(function_name="DraftTaskResult", llm_response=llm_response, mode="request")
        return typing.cast(str, __result__)
...
class LlmStreamParser:
    ...
    def DraftTaskResult(
        ...
        __result__ = self.__options.merge_options(baml_options).parse_response(function_name="DraftTaskResult", llm_response=llm_response, mode="stream")
        return typing.cast(str, __result__)
