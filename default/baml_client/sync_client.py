...
class BamlSyncClient:
    ...
    def DraftTaskResult(self, prompt: str,context: str,system_prompt: str,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="DraftTaskResult", args={
...
class BamlStreamClient:
    ...
    def DraftTaskResult(self, prompt: str,context: str,system_prompt: str,
        ...
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="DraftTaskResult", args={
            "prompt": prompt,"context": context,"system_prompt": system_prompt,
        })
        return baml_py.BamlSyncStream[str, str](
          __result__,
...
class BamlHttpRequestClient:
    ...
    def DraftTaskResult(self, prompt: str,context: str,system_prompt: str,
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="DraftTaskResult", args={
            "prompt": prompt,"context": context,"system_prompt": system_prompt,
        }, mode="request")
        return __result__
